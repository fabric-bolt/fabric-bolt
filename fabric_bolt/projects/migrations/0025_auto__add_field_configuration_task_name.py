...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.task_name'
        db.add_column(u'projects_configuration', 'task_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.task_name'
        db.delete_column(u'projects_configuration', 'task_name')
    ...
    models = {
        ...
        u'projects.configuration': {
            ...
            'task_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
