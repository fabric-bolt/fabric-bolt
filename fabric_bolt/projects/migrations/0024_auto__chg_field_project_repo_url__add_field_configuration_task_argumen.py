...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.repo_url'
        db.alter_column(u'projects_project', 'repo_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
        # Adding field 'Configuration.task_argument'
        db.add_column(u'projects_configuration', 'task_argument',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.repo_url'
        db.alter_column(u'projects_project', 'repo_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
        # Deleting field 'Configuration.task_argument'
        db.delete_column(u'projects_configuration', 'task_argument')
