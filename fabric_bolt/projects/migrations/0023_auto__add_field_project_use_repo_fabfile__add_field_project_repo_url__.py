...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.use_repo_fabfile'
        db.add_column(u'projects_project', 'use_repo_fabfile',
        ...
        # Adding field 'Project.fabfile_requirements'
        db.add_column(u'projects_project', 'fabfile_requirements',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.use_repo_fabfile'
        db.delete_column(u'projects_project', 'use_repo_fabfile')

        # Deleting field 'Project.repo_url'
        db.delete_column(u'projects_project', 'repo_url')

        # Deleting field 'Project.fabfile_requirements'
        db.delete_column(u'projects_project', 'fabfile_requirements')
