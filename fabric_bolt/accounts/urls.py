...
urlpatterns = patterns('',
    ...
    url(r'^register/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$', views.PasswordCreate.as_view(), name='auth_password_reset_confirm'),
    url(r'^register/done/$', 'django.contrib.auth.views.password_reset_complete', name='password_reset_complete'),
)