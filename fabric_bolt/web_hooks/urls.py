...
urlpatterns = [
    ...
    url(r'^(?P<pk>\w+)/$', views.HookDetail.as_view(), name='hooks_hook_view'),
    ...
    url(r'^(?P<pk>\w+)/update/$', views.HookUpdate.as_view(), name='hooks_hook_update'),
    url(r'^(?P<pk>\w+)/delete/$', views.HookDelete.as_view(), name='hooks_hook_delete'),
]
